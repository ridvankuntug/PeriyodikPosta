...
if($_SESSION["kullaniciYetki"] < 2){//Admin tarafından yetki verilmiş mi diye kontrol ediyoruz
  ...
  echo '<meta http-equiv="refresh" content="0;URL=kisi-listesi.php?hata=Yanlış%20Id.">';
}
else{
  try{

    $query = $db->prepare("DELETE FROM kisiler WHERE
    kisi_id = ?");
    ...
    if($delete){//Silme işleminin başarılı olup olmadığını kontrol ediyor
      echo '<meta http-equiv="refresh" content="0;URL=kisi-listesi.php?basarili=Silindi.">';
    }
    else{
      echo '<meta http-equiv="refresh" content="0;URL=kisi-listesi.php?hata=Bir%20Sorun%20Oluştu.">';
    }
  }catch(Exception $e) {
    echo '<meta http-equiv="refresh" content="0;URL=kisi-listesi.php?hata=Bir%20Sorun%20Oluştu.">';
  }
